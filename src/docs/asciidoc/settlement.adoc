...
include::{snippets}/settlement-controller-test/update-account/path-parameters.adoc[]
...
include::{snippets}/settlement-controller-test/get-settlement/path-parameters.adoc[]
...
include::{snippets}/settlement-controller-test/get-header/path-parameters.adoc[]
