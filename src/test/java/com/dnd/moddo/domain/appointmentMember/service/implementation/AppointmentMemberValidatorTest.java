...
class AppointmentMemberValidatorTest {
	private final AppointmentMemberValidator appointmentMemberValidator = new AppointmentMemberValidator();
	...
	void validateGroupMemberNamesNotDuplicate() {
		...
		assertThatCode(() -> {
			appointmentMemberValidator.validateMemberNamesNotDuplicate(names);
